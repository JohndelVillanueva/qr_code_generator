...
<body>
    <!-- base border  -->
    <div class="container-fluid border border-2 border-black vh-50 p-0 m-0">
        <!-- first row School logo + QR Code + Event name -->
        <div class="row col-12 mt-3">
            <!-- left margin  -->
            <div style="width:2%"></div>
            <!-- logo + event name container  -->
            <div class="col-7 border border-2 border-warning d-flex flex-column justify-content-evenly align-items-center">
                <div class="mt-4 h-50">
                    <img src="./assets/logo.PNG" alt="Westfields Logo" class="w-100 h-100">
                </div>
                <div class="mb-4 h-50 d-flex align-items-end pb-4">
                    <p class="h1 fw-medium text-wrap"> Event Name at Event Venue</p>
                </div>
            </div>
            <!-- . margin between  -->
